...
const features: Feature[] = [
  ...
  {
    name: "File Downloads",
    description: "Track PDF, docx, zip, and other downloads",
    icon: FileDown,
    implemented: true,
    difficulty: "easy",
    category: "analytics",
  ...
  {
    name: "Bot Detection",
    description: "Auto-exclude bots, spam, and data center traffic",
    icon: Bot,
    implemented: true,
    difficulty: "easy",
    category: "privacy",
  ...
  {
    name: "Form Analytics",
    description: "Track form submissions and drop-off points",
    icon: FormInput,
    implemented: true,
    difficulty: "medium",
    category: "analytics",
  ...
  {
    name: "Scroll Depth",
    description: "Track how far users scroll on each page (0-100%)",
  ...
  {
    name: "Time on Page",
    description: "Engagement-based time tracking per page",
    icon: Timer,
    implemented: true,
    difficulty: "medium",
    category: "analytics",
  },
  {
    ...
    description: "Track landing pages and exit pages per session",
    icon: LogIn,
    implemented: true,
    difficulty: "medium",
    category: "analytics",
  ...
  {
    name: "Log Analytics",
    description: "Import server logs from Apache, Nginx, IIS",
    icon: FileText,
    implemented: true,
    difficulty: "medium",
    category: "cloud",
  },
  {
    ...
    description: "Connect analytics data to BI tools",
    icon: PieChart,
    implemented: true,
    difficulty: "medium",
    category: "cloud",
  ...
  {
    name: "Annotations",
    description: "Add contextual notes directly onto your charts",
    icon: MessageSquare,
    implemented: true,
    difficulty: "easy",
    category: "insights",
  ...
  {
    name: "Embed Widgets",
    description: "Generate live SVG badges and counters for your site",
    icon: LayoutTemplate,
    implemented: true,
    difficulty: "easy",
    category: "cloud",
  ...
  {
    name: "CLI Tool",
    description: "Interact with your analytics via the command line",
    icon: Command,
    implemented: true,
    difficulty: "medium",
    category: "cloud",
  ...
  {
    name: "AI Insights",
    description: "Automated analysis and actionable traffic observations",
    icon: Sparkles,
    implemented: true,
    difficulty: "medium",
    category: "insights",
